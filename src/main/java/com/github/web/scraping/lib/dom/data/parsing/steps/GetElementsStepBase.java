...
import static com.github.web.scraping.lib.dom.data.parsing.steps.GetElementsStepBase.TraversalFilterOption.*;
...
public abstract class GetElementsStepBase<C> extends CommonOperationsStepBase<C> {
    ...
    public GetElementsStepBase(List<HtmlUnitParsingStep<?>> nextSteps) {
        super(nextSteps);
    }
