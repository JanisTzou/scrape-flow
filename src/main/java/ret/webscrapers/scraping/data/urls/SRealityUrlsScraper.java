...
public class SRealityUrlsScraper extends UrlsScraperBase {
    ...
    // constructor
    public SRealityUrlsScraper(UrlsParser urlsParser) {
        super(urlsParser);
    }
    ...
    private String makePageUrl(String segmentUrl, int currentPage) {
        // page no. == 1:
        // https://www.sreality.cz/hledani/prodej/domy/ustecky-kraj?bez-aukce=1

        // page no. > 1
        // https://www.sreality.cz/hledani/prodej/domy/ustecky-kraj?strana=2&bez-aukce=1

        String pageUrl;
        if (currentPage == 1) {
            pageUrl = segmentUrl;
        } else {
            String stranaPattern = "strana=%d";
            String strana = String.format(stranaPattern, currentPage);
            pageUrl = segmentUrl.replace("bez-aukce=1", strana + "&bez-aukce=1");
        }
        return pageUrl;
    }
