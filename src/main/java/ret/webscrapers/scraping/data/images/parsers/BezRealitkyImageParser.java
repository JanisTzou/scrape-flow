...
public class BezRealitkyImageParser extends DriverOperatorBase<WebDriver> implements ImageParser {

    public BezRealitkyImageParser(DriverManager<WebDriver> driverManager) {
        super(driverManager);
    }
