  ...
  new Scraping()
          .setSequence(
                  Do.navigateTo("https://www.some-news-site.com")
                          .nextBranch(Get.descendants().byAttr("aria-label", "World")
                                  .nextBranch(Get.descendants().byTag("li")
                                          ...
                                          .nextBranch(Get.children().byTag("a")
                                                  .nextBranch(Parse.textContent()
                                                          .collectValue(Section::setName, Section.class)  // defines where to put parsed content
                                                  )
                                                  .nextBranch(Parse.hRef(href -> "https://www.some-news-site.com" + href)
                                                          .nextBranch(goToEachSection())   // impl. omitted
                                                  )
                                          )
                                  )
                          )
